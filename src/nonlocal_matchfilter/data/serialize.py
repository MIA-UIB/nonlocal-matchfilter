...
# Copied from https://github.com/facebookresearch/detectron2/blob/main/detectron2/data/common.py#L144
class TorchSerializedList:
    ...
    def __init__(self, lst: list):
        ...
        self._lst = torch.from_numpy(np.concatenate(self._lst)) if len(
            self._lst) != 0 else torch.empty(0)
    ...
    def __getitem__(self, idx):
        ...
        memory_bytes = memoryview(self._lst[start_addr:end_addr].numpy())
